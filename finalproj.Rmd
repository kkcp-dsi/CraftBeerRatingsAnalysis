...
Too find out the missing values in our cleaned data sets we used a missing_value_plot function we created as part of our course assignment. The missing_value plot function can be found at [plot_missing.R](https://github.com/kkcp-dsi/CraftBeerRatingsAnalysis/blob/main/analysis_notebooks/plot_missing.R)

## Missing Values in Beer Ratings Dataset

```{r}
source("utility/plot_missing.R")
plot_missing(cleaned_all_beers, shortenNames = F)
```
...
```
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" /> <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
...
r2d3(script = "scripts/Interactive.js")
```
