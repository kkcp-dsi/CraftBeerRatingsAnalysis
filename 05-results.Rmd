...
ggplot(aes(average_rating, fct_reorder(state, average_rating))) + 
  ...
  ggtitle("Distribution of brewery rating per state") + 
  xlab("Brewery rating") + 
  ylab("State")
```

Apparently most of the states follow a uni-modal distribution with a few exceptions, those states seem to have a spread-out distribution normally have less breweries, therefore it could be caused by the However all of them seem to peak at the same rating, so it is not very
