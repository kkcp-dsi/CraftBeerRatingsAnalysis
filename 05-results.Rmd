...
ggplot(heatmap_input, aes(fct_reorder(beer_style, rn), fct_rev(fct_reorder(state, freq, max)), fill=rev(scaled_freq))) +
...
ggplot(best_brewery_data, aes(fct_infreq(beer_style), fct_infreq(brewery), fill=rev(scaled_freq))) +
  geom_tile(color="white") + 
    theme(
    panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(),
