...
ggplot(aes(fct_reorder(beer_style, rn), fct_rev(fct_infreq(state)), fill=freq)) +
  ...
  ggtitle("Number of beer styles calculated per state") + 
  xlab("State") + 
  ylab("Beer style")
```