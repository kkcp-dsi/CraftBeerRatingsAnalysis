...
top_brewery_per_state <-
  ...
  select(NAME, brewery_name, average_rating)
...
top_beer_style_per_state <- cleaned_all_beers %>% group_by(state, beer_style) %>%
