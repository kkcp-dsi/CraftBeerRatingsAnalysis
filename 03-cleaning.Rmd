...
```{r}
cleaned_all_breweries <- all_breweries %>% select(name, brewery_type, city, state, longitude, latitude, average_rating, num_of_ratings, num_of_beers, total_check_ins, unique_user_check_ins, brewery) %>% rename(brewery_name = name)
```
