...
\*\* We did check [<https://untapped.com/robots.txt>](https://untapped.com/robots.txt){.uri} to see if scrapping is permitted. They do not have any restrictions under user agents. And we also checked their user agreement. There weren't any rules about getting data for the list of beers. They only mentioned rules about obtaining user data.
